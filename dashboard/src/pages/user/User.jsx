      ...
      <div className="userContainer">
        <div className="userShow">
          <div className="userShowTop">
            <img
              src="https://images.pexels.com/photos/8964547/pexels-photo-8964547.jpeg?auto=compress&cs=tinysrgb&w=1600"
              alt="profile-pic"
          ...
          <div className="userShowBottom">
            ...
            <div className="contactDetails">
              ...
              <div className="userShowInfo">
                <LocationSearchingOutlined />
                <span className="showUserInfoTitle">
                  Leopoldplein 40 , Hasselt Belgium
                </span>
              </div>
            </div>
          </div>
          ...
          <form className="userUpdateForm">
            <div className="userUpdateLeft">
              ...
              <div className="userUpdateItem">
                ...
                <input
                  type="text"
                  placeholder="Leopoldplein 50 3500, Hasselt Belgium"
                  className="userUpdateInput"
                />
              </div>
            </div>
